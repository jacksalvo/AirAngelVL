...
For the first Play release, scripts/google-play-release.ps1 and GOOGLE_PLAY_RELEASE.md provide a resumable draft staging workflow with explicit artifact hashes and remote verification. Read PUBLISHING.md for the latest submission state before using it. The public privacy policy is https://jacksalvo.github.io/AirAngelVL/privacy-policy.html, published from docs/ through GitHub Pages. Keep docs/privacy-policy.html identical to store/privacy-policy.html.
